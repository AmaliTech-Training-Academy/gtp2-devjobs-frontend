...
export class AccountManagementComponent implements OnInit, OnChanges {
...
`;
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if (changes['existingSkills'] && this.existingSkills) {
      this.skills.clear();
    ...
    this.passwordForm = this.fb.group(
      {
        ...
        new: ['', [Validators.required, strongPasswordValidator()]],
        confirm: ['', [Validators.required]],
      },
      {
        validators: [matchPasswordsValidator('new', 'confirm')],
      }
    );
